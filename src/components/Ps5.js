...
const Ps5GameAPI = () => {
    ...
    function FilteredSearch() {
        let filteredGames = ps5Games.filter(element => element.edition.game_name.toLowerCase().includes(searchValue.toLowerCase()));
    ...
    return (
        <>
            <div className="ps5-filter d-flex justify-content-around align-items-center mt-5 mb-5">
                ...
                <input value={searchValue} onChange={(e)=>setSearchValue(e.target.value)} id="ps5_search" className="text-center" type="text" placeholder="search"></input>
            </div>
